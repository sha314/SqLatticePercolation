...
private:
    ...
    long largest_jump_cluster_size{},_previous_cluster_size{};
...
public:
    ...
    long double jump_entropy() {return _largest_jump_entropy;}
    long jump_largest_cluster() {return largest_jump_cluster_size;}
