...
//    run_v10_rsbd<SitePercolationBallisticDeposition_L1_v3>(length, ensemble_size);
//    run_v10_rsbd<SitePercolationBallisticDeposition_L2_v3>(length, ensemble_size);
}
...
//    SitePercolationBallisticDeposition_L1_v3 lp(length, true);
